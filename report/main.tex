...
\begin{document}
    ...
    \section{Discusión de resultados} \label{sec:discusion}
        ...
        \subsection{Tiempo de cómputo}
            Tiempos promedios:
            - Limpieza de datos: 7.7 segundos
            - Proceso de optimización: 42.3 segundos
            - Proceso de limpieza y geo-codificación de domicilios: 12 minutos 57 segundos
            - Despliegue de mapa: 1.18 segundos
