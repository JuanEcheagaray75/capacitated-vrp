...
\begin{document}
    ...
    \section{Justificación} \label{sec:justification}
        ...
        Solamente en los Estados Unidos se gastaron \$ 1.7 billones de dólares en e-commerce durante estos últimos años de pandemia, son \$609 mil millones de dólares más que antes de la pandemia, siendo un crecimiento del 55\% \cite{koetsier-2022}. Uno de los culpables de este crecimiento es lo cómodo que es para el cliente dar un click y recibir lo que quiere en la puerta de su casa. Por medio del e-comercio, el cliente puede observar todos los productos disponibles, ordenar lo que quiera desde la comodidad de su hogar, y simplemente esperar el tiempo de llegada. Para que esto se lleve a cabo de la mejor manera, se debe diseñar una política de reparto eficiente.

        Se esperaría que cualquier mejora en el proceso de transporte de productos tenga efectos positivos en la economía de la empresa. Una reducción de costos de transporte en conjunto con una mejor calidad de servicio tienen efectos positivos en todas las partes involucradas en el proceso logístico \cite{decision2002economic}. Realizar un proceso de optimización constante le abriría las puertas a la empresa a un mercado más amplio, así como facilitaría la adquisición de bienes, generando mejoras en costo y calidad de los productos vendidos por la empresa.

        En una era en la que el e-commerce no presenta evidencia alguna de dejar de crecer, es imperativo que las empresas que ofrezcan este servicio optimicen todos sus procesos de logística y cadena de suministro.
