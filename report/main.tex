...
\begin{document}
    ...
    \section{Objeto de estudio} \label{sec:case-study}
        ...
        Los vehículos solamente realizar ́an entregas a los clientes de la empresa, es decir, no habrá etapa alguna de carga de paquetes m ́as que en el centro de distribución; aunado a esto, cada uno de los clientes se visitar ́a una sola vez, esto hace referencia a que si uno de los clientes orden ́o m ́as de un producto, se entregar ́an todas sus ordenes en el momento en que sea visitado.
