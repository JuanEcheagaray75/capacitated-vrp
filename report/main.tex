...
\begin{document}
    ...
    \section{Conclusiones} \label{sec:conclusions}
        ...
        La aplicación desarrollada es capaz de producir resultados cercanos a la optimalidad con recursos computacionales limitados en un tiempo de operación aceptable, esta aplicación solamente se vería beneficiada si es que se ejecutase en un ordenador de carácter industrial, volviendo sencillo encontrar mejores soluciones en ventanas de tiempo cada vez más pequeñas.
